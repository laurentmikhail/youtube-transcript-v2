...
async def get_youtube_transcript(video_url: str):
    ...
    try:
        ...
        transcript = None
        # Try to find English, Spanish, French or German generated transcript
        try:
            transcript = transcript_list.find_generated_transcript(['en', 'es', 'fr', 'de'])
        except NoTranscriptFound:
            pass # No generated transcript found, try manually created
        ...
        if not transcript:
            try:
                ...
                pass # No manually created transcript found, try any available
        ...
        # This will catch NoMuxedTranscriptFound if it still occurs, as well as other unexpected errors
